  ...
  return (
    <div className="flex items-center justify-center h-[calc(100vh-150px)]">
      <div className="text-center max-w-md mx-auto p-6 bg-white shadow-lg rounded-3xl animate-fade-in">
        ...
        <h1 className="text-2xl font-bold text-gray-700 mb-4">Transaction in Progress</h1>
        <p className="text-yellow-500 mb-6">
          We are generating your transaction hash on the blockchain. This might take a moment. Please wait...
        </p>
      </div>
    </div>
  );
